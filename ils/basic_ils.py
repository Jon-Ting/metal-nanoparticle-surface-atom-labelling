...
def ILS(df, labelColumn, outColumn='LS', iterative=True):
    ...
    Citation and implementation details : ""
    ...
    OUTPUTS :
        ...
        pandas dataFrame:
            ...
            columns:
                ...
                IDclosestLabelled : ID of point label received from'
     '''
    ...
    while len(unlabelled) > 0:
        ...
        # (The oLooking rdering will switch during iterations, more robust)
        ...
        # For python > 3.7 do not use append
    ...
    # Reodered index for consistency
